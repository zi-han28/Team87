      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex items-center md:order-2 space-x-3">
          ...
          <button
            ...
            {user.isLoggedIn ? (
              ...
              <div className="w-10 h-10 absolute top-[25px] right-[150px] rounded-full bg-blue-500 flex items-center justify-center text-white text-xl">
        ...
        <div className={`items-center ${isNavOpen ? "block" : "hidden"} w-full md:flex md:w-auto md:order-1`}>
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 md:space-x-8 md:flex-row">
            ...
            <li><Link href="/chatroom" className="block py-2 px-3 text-gray-900 rounded-md hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 dark:text-white">chatroom</Link></li>
