...
// Function to open SQLite database (Updated as requested)
            ...
            req.json().then(async ({ query }) => {
                ...
                db.all(
                    ...
                    async (err, posts) => {
                        ...
                        if (posts.length === 0) {
                            return resolve(new Response(JSON.stringify({ answer: "No relevant posts found.", posts: [] }), { status: 200 }));
                        }
                        ...
                        console.log("Sending to OpenAI:", postContent);
                        ...
                        try {
                            ...
                            return resolve(new Response(JSON.stringify({ answer: response.choices[0].message.content, posts }), {
                                status: 200,
